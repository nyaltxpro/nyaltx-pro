...
export default function Sidebar({ isMobileMenuOpen, toggleMobileMenu }: SidebarProps) {
  ...
  return (
    <>
      ...
      <motion.div
        className={`fixed left-0 top-0 h-full bg-black/95 backdrop-blur-xl border-r border-gray-800/50 z-[99999998] ${!isDesktop && (isMobileMenuOpen ? 'translate-x-0' : '-translate-x-full')
          }`}
        style={{
