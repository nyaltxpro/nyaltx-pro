      ...
      <div className="container mx-auto">
        ...
        <div className="grid grid-cols-3 gap-8 mb-8">
          ...
          <div className='col-span-2'>
            ...
            <h3 className="text-lg font-medium mb-4">Be part of Nyltax Force community! The premium community of Nyltaxools</h3>
            ...
            <div className="grid grid-cols-3 gap-8 mb-8">
              ...
              <div className="bg-[#1a2632] rounded-lg p-4">
                <div className="flex items-center mb-2">
                  <div className="mr-2">🐬</div>
                  <h4 className="font-semibold">Nyltax Force</h4>
                </div>
                <p className="text-xs">
                  You can access holding 1000 Nyltax and verifying your wallet.
                </p>
              </div>

              {/* Nyltax Force Ventures Tier */}
              <div className="bg-[#1a2632] rounded-lg p-4">
                <div className="flex items-center mb-2">
                  <div className="mr-2">🐳</div>
                  <h4 className="font-semibold">Nyltax Force Ventures</h4>
                </div>
                <p className="text-xs">
                  You can access holding 10k Nyltax, it includes exclusive access to our ventures and all the community deals.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className='col-span-1'>
            ...
            <div className="grid grid-cols-3 md:grid-cols-3 gap-4">
              <Link href="https://twitter.com/NyltaxoolsApp" target="_blank" rel="noopener noreferrer" className="flex flex-col items-center">
                <FaXTwitter className="text-2xl mb-1" />
                <span className="text-xs">Twitter</span>
              </Link>
              <Link href="https://www.instagram.com/Nyltaxools.io/" target="_blank" rel="noopener noreferrer" className="flex flex-col items-center">
                <BsInstagram className="text-2xl mb-1" />
                <span className="text-xs">Instagram</span>
              </Link>
              <Link href="https://www.youtube.com/c/NyltaxoolsOfficial" target="_blank" rel="noopener noreferrer" className="flex flex-col items-center">
                <FaYoutube className="text-2xl mb-1" />
                <span className="text-xs">Youtube</span>
              </Link>
              <Link href="https://t.me/NyltaxoolsCommunity" target="_blank" rel="noopener noreferrer" className="flex flex-col items-center">
                <FaTelegram className="text-2xl mb-1" />
                <span className="text-xs">Telegram</span>
              </Link>
              <Link href="https://www.tiktok.com/@Nyltaxools.io" target="_blank" rel="noopener noreferrer" className="flex flex-col items-center">
                <FaTiktok className="text-2xl mb-1" />
                <span className="text-xs">TikTok</span>
              </Link>
              <Link href="https://medium.com/@NyltaxoolsOfficial" target="_blank" rel="noopener noreferrer" className="flex flex-col items-center">
        ...
        <div className='bg-[#142028] flex w-full flex-col'>
          ...
          <div className="flex flex-col md:flex-row justify-between items-center  pt-4">
            ...
            <div className="grid grid-cols-5 space-x-4 mb-4 md:mb-0">
              <Link href="https://twitter.com/NyltaxoolsApp" target="_blank" rel="noopener noreferrer">
                <FaXTwitter className="text-gray-400 hover:text-white" />
              </Link>
              <Link href="https://t.me/NyltaxoolsCommunity" target="_blank" rel="noopener noreferrer">
                <FaTelegram className="text-gray-400 hover:text-white" />
              </Link>
              <Link href="https://medium.com/@NyltaxoolsOfficial" target="_blank" rel="noopener noreferrer">
                <BsMedium className="text-gray-400 hover:text-white" />
              </Link>
              <Link href="https://www.instagram.com/Nyltaxools.io/" target="_blank" rel="noopener noreferrer">
                <BsInstagram className="text-gray-400 hover:text-white" />
              </Link>
              <Link href="https://www.youtube.com/c/NyltaxoolsOfficial" target="_blank" rel="noopener noreferrer">
            ...
            <div className="flex w-[20%] mx-2  space-x-4">
              <Link href="https://apps.apple.com/app/Nyltaxools" target="_blank" rel="noopener noreferrer">
                <Image src="/app-store-badge.svg" alt="App Store" width={120} height={40} />
              </Link>
              <Link href="https://play.google.com/store/apps/details?id=com.Nyltaxools" target="_blank" rel="noopener noreferrer">
            ...
            <div className="flex w-[60%]  flex-wrap justify-center md:justify-between mt-6 text-sm">
              <div className="flex flex-wrap justify-center space-x-4 mb-4 md:mb-0">
                ...
                <Link href="/Nyltax-token" className="text-blue-400 hover:text-blue-300">Nyltax Token</Link>
              ...
              <div className="text-xs text-gray-400 text-center md:text-right">
                © Nyltaxools.io 2025 - 2149.0 - info@Nyltaxools.io | Ads & Marketing: marketing@Nyltaxools.io
              </div>
            </div>
          </div>
        </div>
