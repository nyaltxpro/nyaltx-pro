          ...
          tronNewTokens.map(token => (
            <div key={token.id} className="p-3 border-b border-gray-800 hover:bg-gray-800">
              <div className="flex justify-between items-center mb-2">
                <div className="flex items-center">
                  ...
                  <div>
                    <div className="flex items-center">
                      ...
                      <span className="text-blue-400 text-xs ml-2 px-1 rounded bg-blue-900">
                        TRX
                      </span>
                    </div>
                ...
                <button className="px-3 py-1 bg-[#00b8d8] text-white text-xs font-bold rounded">
                  TRADE
                </button>
              </div>
        ...
        {tronPreLaunchedTokens.map(token => (
          <div key={token.id} className="p-3 border-b border-gray-800 hover:bg-gray-800">
            <div className="flex justify-between items-center mb-2">
              <div className="flex items-center">
                <div className="w-8 h-8 rounded-md mr-2 overflow-hidden">
                  <Image src={token.logoUrl} alt={token.name} width={32} height={32} unoptimized />
                </div>
                <div>
                  <div className="flex items-center">
                    <span className="text-white font-medium">{token.name}</span>
            ...
            {token.launchDate && (
              <div className="mt-2 flex justify-between items-center">
                ...
                {token.holders && <div className="text-xs text-green-500">{token.holders}</div>}
              </div>
            )}
          </div>
        ))}
