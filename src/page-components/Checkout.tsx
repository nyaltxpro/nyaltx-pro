...
const products = [
    {
        id: 1,
        name: 'Pro Plan',
        desc: 'Advanced analytics and alerts',
        priceUsd: 19.99,
        image: '/logo.png',
        qty: 1,
    },
...
const Checkout = () => {
    ...
    const filteredTokens = showRegisteredTokens ? allTokens.filter(t => t.isRegistered) : allTokens;

    const subtotal = useMemo(() => products.reduce((s, p) => s + p.priceUsd * p.qty, 0), []);
    const discount = useMemo(
        () => (promo.trim().toUpperCase() === 'NYAX10' ? subtotal * 0.1 : 0),
        [promo, subtotal]
    );
    ...
    const handlePay = async () => {
        ...
        try {
            ...
            if (selectedToken?.isRegistered) {
                console.log(
                    `Using registered token: ${selectedToken.symbol} with ${selectedToken.boost} boost points`
                );
                    ...
                    <div className="bg-gray-800/40 backdrop-blur-lg border border-gray-700/20 rounded-xl p-6 shadow-xl">
                        ...
                        <div className="mb-6">
                            <div className="flex items-center mb-2">
                                <div className="w-6 h-6 rounded-full bg-[#00b8d8] text-white flex items-center justify-center text-xs mr-2">
                                    1
                                </div>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <div>
                                    ...
                                    <div className="flex gap-2">
                                        ...
                                        />
                                        <button className="px-3 py-2 bg-[#1a2932] border border-gray-700 rounded-md text-gray-300 hover:text-white">
                                            Apply
                                        </button>
                                    </div>
                                    ...
                                    {userTokens.length > 0 && (
                                        <div className="mt-2 flex items-center gap-2">
                                            <button
                                                ...
                                                className={`text-xs px-2 py-1 rounded transition-colors ${showRegisteredTokens
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                                    <div>
                                        ...
                                        <input
                                            ...
                                            onChange={e =>
                                                setTokenRegistrationData(prev => ({ ...prev, tokenName: e.target.value }))
                                            }
                                    ...
                                    <div>
                                        ...
                                        <input
                                            ...
                                            onChange={e =>
                                                setTokenRegistrationData(prev => ({ ...prev, tokenSymbol: e.target.value }))
                                            }
                                            placeholder="ETH"
                                            className="w-full px-3 py-2 bg-[#1a2932] border border-gray-700 rounded-md text-white focus:outline-none focus:ring-1 focus:ring-cyan-500"
                                        />
                                    ...
                                    <div>
                                        ...
                                        <input
                                            ...
                                            onChange={e =>
                                                setTokenRegistrationData(prev => ({ ...prev, imageUri: e.target.value }))
                                            }
                                    ...
                                    <div>
                                        ...
                                        <input
                                            ...
                                            onChange={e =>
                                                setTokenRegistrationData(prev => ({ ...prev, website: e.target.value }))
                                            }
                                ...
                                <div className="flex justify-between items-center">
                                    ...
                                    <div className="flex gap-2">
                                        ...
                                        <button
                                            ...
                                            disabled={
                                                !tokenRegistrationData.tokenName ||
                                                !tokenRegistrationData.tokenSymbol ||
                                                !tokenRegistrationData.contractAddress
                                            }
