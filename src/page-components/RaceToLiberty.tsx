      ...
      {showInfo && (
        <div className="bg-gradient-to-r from-cyan-500/10 to-purple-500/10 border border-cyan-500/20 rounded-2xl p-6">
          ...
          <div className="text-sm text-gray-400">
            <p className="mb-2">
              <strong>Boost Packs:</strong>
            </p>
            <ul className="space-y-1 ml-4">
              <li>
                • <strong>Paddle Boat ($300):</strong> 100 points, 24h decay
              </li>
              <li>
                • <strong>Motor Boat ($500):</strong> 250 points, 36h decay + social eligibility
              </li>
              <li>
                • <strong>Helicopter ($700):</strong> 500 points, 48h decay + podcast promotion
              </li>
            </ul>
          </div>
        </div>
