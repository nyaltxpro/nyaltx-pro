            ...
            <div className="container mx-auto px-4 py-8">
                ...
                <div className="max-w-4xl mx-auto prose prose-invert">
                    ...
                    <section className="mb-8">
                        ...
                        <p>
                            By accessing or using the Cryptic platform, website, and services (collectively, the
                    ...
                    <section className="mb-8">
                        ...
                        <p>
                            Cryptic provides a platform for tracking cryptocurrency prices, viewing charts,
                            analyzing market data, and connecting digital wallets for portfolio tracking. Our
                    ...
                    <section className="mb-8">
                        ...
                        <p className="mb-4">
                            Some features of our Services may require you to connect a digital wallet or create an
                    ...
                    <section className="mb-8">
                        ...
                        <p>
                            ...
                            text, graphics, logos, icons, and software, are owned by Cryptic or its licensors and
                    ...
                    <section className="mb-8">
                        ...
                        <p>
                            ...
                            responsible for the content or practices of these third-party sites and services. Your
                            interactions with any third-party website or service are solely between you and that
                            third party.
                        </p>
                    </section>
                    ...
                    <section className="mb-8">
                        ...
                        <p>
                            ...
                            EITHER EXPRESS OR IMPLIED. TO THE FULLEST EXTENT PERMISSIBLE UNDER APPLICABLE LAW, WE
                    ...
                    <section className="mb-8">
                        ...
                        <p>
                            TO THE MAXIMUM EXTENT PERMITTED BY LAW, CRYPTIC SHALL NOT BE LIABLE FOR ANY INDIRECT,
                    ...
                    <section className="mb-8">
                        ...
                        <p>
                            ...
                            our Services after such modifications constitutes your acceptance of the revised
                            Terms.
                        </p>
                    </section>
                    ...
                    <section className="mb-8">
                        ...
                        <p>
                            ...
                            jurisdiction in which Cryptic is established, without regard to its conflict of law
                            provisions.
                        </p>
                    </section>
                    ...
                    <section>
                        ...
                        <p>
                            If you have any questions about these Terms, please contact us through our Contact
                            page or at legal@cryptic.com.
                        </p>
                    </section>
                </div>
            </div>
