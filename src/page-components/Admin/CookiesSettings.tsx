            ...
            <section className="container mx-auto px-4 pt-16 pb-8">
                ...
                >
                    ...
                    <p className="max-w-3xl text-white/70">
                        Control how we use cookies to improve your experience. You can update these at any time.
                    </p>
                </motion.div>
            </section>
                ...
                <div className="max-w-7xl mx-auto space-y-8">
                    ...
                    >
                        ...
                        <div className="relative p-6 md:p-10">
                            ...
                            <p className="mb-4">
                                Cookies are small text files that are placed on your device to help the site provide
                                a better user experience. In general, cookies are used to retain user preferences,
                                store information for things like shopping carts, and provide anonymized tracking
                                data to third-party applications like Google Analytics.
                            </p>
                            <p>
                                As a rule, cookies will make your browsing experience better. However, you may
                                prefer to disable cookies on this site and on others. The most effective way to do
                                this is to disable cookies in your browser. We suggest consulting the Help section
                                of your browser.
                            </p>
                        </div>
                    </motion.div>
                    ...
                    >
                        ...
                        <div className="relative p-6 md:p-10">
                            ...
                            <p className="mb-4">
                                Our Cookie Policy explains what cookies are, how we use them, how third parties we
                                may partner with may use cookies on our website, your choices regarding cookies, and
