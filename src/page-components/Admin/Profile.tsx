...
const AdminProfilesClient = dynamic(() => Promise.resolve(AdminProfilesComponent), {
    ssr: true,
});
...
function AdminProfilesComponent() {
    ...
    const remove = async (id: string) => {
        ...
        setError(null);
        try {
            const r = await fetch(`/api/admin/profiles?id=${encodeURIComponent(id)}`, {
                method: 'DELETE',
            });
            ...
            <div className="rounded-xl border border-gray-800 p-4">
                ...
                <form onSubmit={submitCreate} className="grid grid-cols-1 md:grid-cols-6 gap-2">
                    ...
                    <select
                        ...
                        value={form.paidTier ?? ''}
                        onChange={e => setForm({ ...form, paidTier: (e.target.value || null) as any })}
                    >
                    ...
                    <div className="md:col-span-6">
                        <button
                            disabled={busy}
                            className="rounded bg-emerald-600 hover:bg-emerald-500 px-4 py-2 text-sm"
                        >
                            Create
                        </button>
                    </div>
            ...
            {editing && (
                <div className="rounded-xl border border-gray-800 p-4">
                    ...
                    <form onSubmit={submitEdit} className="grid grid-cols-1 md:grid-cols-6 gap-2">
                        ...
                        <select
                            className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                            value={editing.paidTier ?? ''}
                            onChange={e => setEditing({ ...editing, paidTier: (e.target.value || null) as any })}
                        >
                            <option value="">No tier</option>
                            <option value="paddle">Paddle</option>
                            <option value="motor">Motor</option>
                        ...
                        <div className="md:col-span-6 flex items-center gap-2">
                            ...
                            <button
                                type="button"
                                className="rounded bg-gray-700 hover:bg-gray-600 px-4 py-2 text-sm"
