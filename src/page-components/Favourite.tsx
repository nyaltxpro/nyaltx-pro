...
import { FaExternalLinkAlt, FaSpinner, FaStar, FaSync, FaTrash, FaWallet } from 'react-icons/fa';
                    ...
                    <div className="flex items-center justify-between mb-8">
                        ...
                        <div className="flex items-center gap-3">
                            ...
                            <button
                                ...
                                className={`p-2 rounded-full transition-all duration-200 ${isRefreshing || isLoading
                                        ...
                                        <div className="flex items-center justify-between">
                                            <div className="flex items-center gap-4">
                                                ...
                                                <div>
                                                    <div className="flex items-center gap-2 mb-1">
                                                        ...
                                                        <div
                                                            className={`px-2 py-1 rounded-full text-xs font-medium text-white ${chainColors[favorite.chain_id] || 'bg-gray-500'}`}
                                                        >
                                            ...
                                            <div className="flex items-center gap-2">
                                                ...
                                                <button
                                                    ...
                                                    className={`p-2 rounded-full transition-all duration-200 ${removingId === favorite.id
