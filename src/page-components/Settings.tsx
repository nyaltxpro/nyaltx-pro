...
export default function SettingsPage() {
    ...
    const clearAllData = () => {
        if (
            confirm(
                'This will clear all your data including settings, favorites, and cache. Are you sure?'
            )
        ) {
            localStorage.clear();
                                                ...
                                                {[
                                                    ...
                                                    return (
                                                        <motion.button
                                                            ...
                                                            className={`p-4 rounded-lg border-2 transition-all duration-200 ${settings.theme === theme.value
                                            ...
                                            <div className="grid grid-cols-6 gap-3">
                                                {[
                                                    ...
                                                    <motion.button
                                                        ...
                                                        className={`w-12 h-12 rounded-lg border-2 ${settings.accentColor === color
                                            ...
                                            <div className="grid grid-cols-3 gap-4">
                                                {[
                                                    ...
                                                    <button
                                                        ...
                                                        className={`p-4 rounded-lg border transition-all duration-200 ${settings.fontSize === size.value
                                                            ? 'border-cyan-500 bg-cyan-500/10 text-cyan-400'
                                                            : 'border-gray-600 bg-gray-700/50 text-gray-300 hover:border-gray-500'
                                                            }`}
                                                    >
                                            ...
                                            {[
                                                {
                                                    key: 'priceAlerts',
                                                    label: 'Price Alerts',
                                                    desc: 'Get notified when token prices change significantly',
                                                },
                                                {
                                                    key: 'newListings',
                                                    label: 'New Token Listings',
                                                    desc: 'Get notified when new tokens are listed',
                                                },
                                                {
                                                    key: 'airdrops',
                                                    label: 'Airdrops',
                                                    desc: 'Get notified about new airdrops and rewards',
                                                },
                                                {
                                            ...
                                            {[
                                                {
                                                    key: 'cookies',
                                                    label: 'Cookies',
                                                    desc: 'Allow cookies to enhance your browsing experience',
                                                },
                                                {
                                                    key: 'analytics',
                                                    label: 'Analytics',
                                    ...
                                    <div className="space-y-8">
                                        ...
                                        <div className="space-y-6">
                                                ...
                                                <div className="grid grid-cols-3 gap-4">
                                                    {[
                                                        ...
                                                        <button
                                                            ...
                                                            className={`p-4 rounded-lg border text-left transition-all ${settings.gasPreference === gas.value
                                                                ? 'border-cyan-500 bg-cyan-500/10 text-cyan-400'
                                                                : 'border-gray-600 bg-gray-700/50 text-gray-300 hover:border-gray-500'
                                                                }`}
                                                        >
                                            ...
                                            <div className="space-y-4">
                                                {[
                                                    {
                                                        key: 'showTradeHistory',
                                                        label: 'Show Trade History',
                                                        desc: 'Display your trade history on charts',
                                                    },
                                                    {
                                                        key: 'autoApprove',
                                                        label: 'Auto Approve Transactions',
                                                        desc: 'Automatically approve known transactions',
                                                    },
                                                ].map(item => (
                                                    <div
                                                        key={item.key}
