        ...
        <div className="min-h-screen bg-gray-900 text-white">
            ...
            <div className="container mx-auto px-4 py-4">
                ...
                <div className="mb-6 overflow-x-auto">
                    <div className="flex space-x-2 min-w-max pb-2">
                        {categories.map(category => (
                            <button
                                key={category.id}
                                className={`px-4 py-2 rounded-lg flex items-center ${activeCategory === category.id ? 'bg-[#00b8d8]' : 'bg-gray-800'
                                    }`}
                ...
                <div className="mb-8">
                    ...
                    <div className="bg-[#0f1923] rounded-lg p-6">
                        ...
                        <p className="text-gray-400 mb-4">
                            Access our comprehensive crypto data API for your applications. Get market data, token
                            information, and more.
                        </p>

                        <div className="flex items-center mb-4 overflow-x-auto">
                            <Image
                                src={getCryptoIconUrl('btc')}
                                width={24}
                                height={24}
                                alt="Bitcoin"
                                className="mr-1"
                        ...
                        <div className="bg-gray-800 p-3 rounded-md mb-4 relative">
                            ...
                            >
                                {copied === 'https://api.cryptic.io/v1/tokens?apikey=YOUR_API_KEY' ? (
                                    <FaCheck />
                                ) : (
                                    <FaRegCopy />
                                )}
                ...
                <div className="mb-8">
                    ...
                    <div className="bg-[#0f1923] rounded-lg p-6">
                        <p className="text-gray-400 mb-4">
                            Don&apos;t see the tool you need? Let us know what would help you in your crypto
                            journey.
                        </p>
                ...
                <div className="bg-gray-800 p-4 rounded-lg mb-8 flex items-start">
                    ...
                    <p className="text-sm text-gray-300">
                        The tools provided are for informational purposes only and should not be considered
                        financial advice. Always do your own research before making investment decisions. Some
                        tools may require connecting your wallet, please review permissions carefully.
                    </p>
                </div>
            </div>
        </div>
