    ...
    return (
        <div className="min-h-screen">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 items-center gap-10">
                        <motion.div className="max-w-3xl" variants={fadeUp}>
                            ...
                            <div className="mt-6 flex flex-wrap gap-3">
                                ...
                                <Link
                                    href="/pricing"
                                    className="rounded-full border border-white/10 bg-white/5 px-5 py-2.5 font-medium text-white hover:bg-white/10 transition-colors"
                                >
                                    View Pricing
                                </Link>
                            </div>
                        ...
                        <motion.div className="flex justify-center md:justify-center" variants={scaleIn}>
                            <div className="relative">
                                ...
                                <Image
                                    src={landingContent?.hero?.backgroundImage || '/hero2.png'}
                                    alt="NYALTX Logo"
                                    width={300}
                                    height={300}
                                    priority
          ...
          `}</style>
            ...
            <motion.section
                className="border-y border-white/10 bg-white/[0.03] backdrop-blur"
                variants={container}
                initial="hidden"
                whileInView="show"
                viewport={{ once: true, amount: 0.2 }}
            ...
            >
                ...
                <motion.p className="mt-2 text-gray-300/90 max-w-2xl" variants={fadeUp}>
                    Connect seamlessly with leading wallets.
                </motion.p>
                <div className="mt-8 grid grid-cols-2 sm:grid-cols-3 md:grid-cols-6 gap-4">
                    {[
                        ...
                        <motion.div
                            key={i}
                            variants={scaleIn}
                            className="group relative border border-white/10 rounded-2xl bg-gradient-to-b from-white/5 to-white/[0.03] p-4 backdrop-blur-md flex flex-col items-center justify-center gap-2 hover:shadow-[0_0_40px_-10px_rgba(99,102,241,0.35)]"
                        >
            ...
            <motion.section
                ...
                viewport={{ once: true, amount: 0.2 }}
            >
                <motion.h2 className="text-2xl md:text-3xl font-bold" variants={fadeUp}>
                    How it works
                </motion.h2>
                <div className="mt-8 grid grid-cols-1 md:grid-cols-3 gap-4">
                    <motion.div variants={fadeUp}>
                        <Step
                            index={1}
                            title="Sign up for NYALTX Pro"
                            desc="Create your Pro account to unlock listings and placements."
                        />
                    </motion.div>
                    <motion.div variants={fadeUp}>
                        <Step
                            index={2}
                            title="Choose a tier"
                            desc="Pick Paddle, Motor, or Helicopter depending on your goals."
                        />
                    </motion.div>
                    <motion.div variants={fadeUp}>
                        <Step
                            ...
                            desc="Monitor stats, engage with holders, and scale your reach."
                        />
                    </motion.div>
                </div>
            </motion.section>
                ...
                <div className="mt-8 grid grid-cols-1 md:grid-cols-3 gap-4">
                    {landingContent?.testimonials?.items?.map((testimonial, i) => (
                        ...
                        >
                            ...
                            <div className="mt-3 flex items together gap-3">
                                <div>
            ...
            >
                <motion.h2
                    className="text-2xl md:text-3xl font-bold mb-4 bg-clip-text text-transparent bg-gradient-to-r from-cyan-400 to-indigo-400"
                    variants={fadeUp}
                >
                    FAQ
                </motion.h2>
            ...
            >
                ...
                <motion.p className="mt-2 text-gray-300/90 max-w-2xl" variants={fadeUp}>
                    We surface pricing and pairs data from leading DEXs and networks.
                </motion.p>
                <div className="mt-8 grid grid-cols-2 sm:grid-cols-3 md:grid-cols-6 gap-4">
                    {[
                        ...
                        <motion.div
                            key={i}
                            variants={scaleIn}
                            className="rounded-2xl border border-white/10 bg-gradient-to-b from-white/5 to-white/[0.03] p-4 backdrop-blur text-center"
                        >
            ...
            >
                ...
                <div className="mt-8 grid grid-cols-1 md:grid-cols-3 gap-4">
                    {[
                        {
                            t: 'Non-custodial',
                            d: 'You keep control. Connect your wallet and transact directly on-chain.',
                        },
                        {
                            t: 'Multi-network',
                            d: 'Ethereum-first with expanding L2 and multi-chain coverage.',
                        },
                        {
                            t: 'Dev-friendly',
                            d: 'Modular architecture and API pathways planned for partners.',
                        },
                    ].map((x, i) => (
                        <motion.div
                            key={i}
                            variants={scaleIn}
                            className="group relative rounded-2xl border border-white/10 bg-gradient-to-b from-white/5 to-white/[0.03] p-5 backdrop-blur-md"
                        >
            ...
            >
                <motion.div
                    className="rounded-xl border border-gray-800 bg-gray-900/40 p-6 md:p-8 flex flex-col md:flex-row items-start md:items-center justify-between gap-4"
                    variants={scaleIn}
                >
                    <div>
                        <h3 className="text-xl md:text-2xl font-semibold">Ready to get visibility?</h3>
                        <p className="text-gray-300">
                            Start with NYALTX Pro, then choose a promotional tier that fits your roadmap.
                        </p>
                    </div>
...
function CryptoIcon({
    ...
    try {
        ...
        // Ignore runtime icon errors and fallback to local asset.
    }
    ...
    return (
        <div ref={ref} className="p-1">
            ...
            <div className="mt-1 text-2xl md:text-3xl font-extrabold" style={{ color: color }}>
                <span className={`${highlight ? 'text-cyan-400' : ''}`}>
                    {display}
                    {suffix}
                </span>
            </div>
...
function Step({ index, title, desc }: { index: number; title: string; desc: string }) {
    return (
        <div className="group relative rounded-2xl border border-white/10 bg-white/[0.03] p-5 backdrop-blur-md transition-all duration-300 hover:shadow-[0_0_40px_-10px_rgba(99,102,241,0.35)]">
            <div className="inline-flex h-7 w-7 items-center justify-center rounded-full bg-cyan-500 text-black text-sm font-bold">
                {index}
            </div>
