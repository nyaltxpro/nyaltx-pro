                    ...
                    <div className="bg-[#0f1923] rounded-lg p-1 shadow-lg">
                        <div className="flex space-x-1">
                            <button
                                ...
                                className={`flex-1 py-3 px-4 rounded-lg font-medium text-sm transition-all duration-300 ${activeTab === 'uniswap'
                            ...
                            <button
                                ...
                                className={`flex-1 py-3 px-4 rounded-lg font-medium text-sm transition-all duration-300 ${activeTab === 'raydium'
                            ...
                            {quotes.length > 0 && (
                                <div className="mt-4 mb-4 bg-gray-800 rounded-lg p-3">
                                    ...
                                    {quotes.map((quote, index) => {
                                        const exchange = availableExchanges.find(
                                            ex => ex.config.name === quote.protocol
                                        );
