            ...
            <div className="flex items-center justify-between">
                <div>
                    ...
                    <p className="text-gray-400">
                        Watch live streams and create your own with wallet connection
                    </p>
                </div>
                ...
                <div className="flex items-center gap-4">
                    ...
                    <div className="flex items-center gap-2 bg-gray-800 rounded-lg p-1">
                        <button
                            ...
                            className={`flex items-center gap-2 px-3 py-2 rounded-md text-sm font-medium transition-colors ${streamingPlatform === 'streamio'
                                    ...
                                    >
                                        ...
                                        <div className="p-4">
                                            ...
                                            <div className="flex items-center justify-between">
                                                ...
                                                <span
                                                    className={`px-2 py-1 rounded-full text-xs ${getCategoryColor(stream.category)}`}
                                                >
                                                    {stream.category}
                                                </span>
                                            </div>
