...
export default function NewPairsPage() {
    ...
    const toggleFavorite = (id: number, e: React.MouseEvent) => {
        e.stopPropagation();
        setPairs(pairs.map(pair => (pair.id === id ? { ...pair, favorite: !pair.favorite } : pair)));
    };
                        ...
                        <tbody className="divide-y divide-gray-700">
                            {currentItems.map(pair => (
                                ...
                                >
                                    ...
                                    <td className="px-4 py-4">
                                        <div className="flex items-center">
                                            <div className="mr-2">
                                                {pair.verified && (
                                                    <span
                                                        className="bg-green-500 rounded-full w-3 h-3 inline-block mr-1"
                                                        title="Verified"
                                                    ></span>
                                                )}
                                            </div>
                                    ...
                                    <td
                                        className={`px-4 py-4 ${pair.change24h.startsWith('+') ? 'text-green-500' : 'text-red-500'}`}
                                    >
                                        {pair.change24h}
                                    </td>
