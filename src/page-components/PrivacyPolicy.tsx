        ...
        <div className="min-h-screen  text-white">
            ...
            <div className="container mx-auto px-4 py-8">
                ...
                <div className="prose dark:prose-invert max-w-none">
                    ...
                    <p>
                        At New York Alt Exchange, we are committed to protecting the privacy of our users. This
                        privacy policy describes how we collect, use, and protect the personal information you
                        provide through our application.
                    </p>
                    ...
                    <p>
                        All collected information is stored in our secure database and is not shared with third
                        parties. We implement appropriate security measures to protect your data against
                    ...
                    <p>
                        ...
                        <a href="mailto:info@nyaltx.com" className="text-blue-500 hover:underline ml-1">
                            info@nyaltx.com
                        </a>
                    </p>
                    ...
                    <p>
                        ...
                        any changes through our application or via email.
                    </p>
