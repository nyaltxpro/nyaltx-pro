            ...
            <main className="flex-1 flex">
                ...
                <div className="w-full max-w-3xl mx-auto mt-8 px-4">
                    <div className="flex items-center justify-center mb-12">
                        <div
                            className={`w-8 h-8 rounded-full flex items-center justify-center ${currentStep >= 1 ? 'bg-[#00b8d8]' : 'bg-gray-700'}`}
                        >
                            <span className="text-sm">1</span>
                        </div>
                        <div
                            className={`h-0.5 w-24 ${currentStep >= 2 ? 'bg-[#00b8d8]' : 'bg-gray-700'}`}
                        ></div>
                        <div
                            className={`w-8 h-8 rounded-full flex items-center justify-center ${currentStep >= 2 ? 'bg-[#00b8d8]' : 'bg-gray-700'}`}
                        >
                            <span className="text-sm">2</span>
                        </div>
                        <div
                            className={`h-0.5 w-24 ${currentStep >= 3 ? 'bg-[#00b8d8]' : 'bg-gray-700'}`}
                        ></div>
                        <div
                            className={`w-8 h-8 rounded-full flex items-center justify-center ${currentStep >= 3 ? 'bg-[#00b8d8]' : 'bg-gray-700'}`}
                        >
