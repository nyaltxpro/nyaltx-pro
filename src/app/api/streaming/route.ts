...
let broadcasters: Record<
  string,
  { walletAddress?: string; streamTitle?: string; lastSeen: number }
> = {};
let viewers: Record<string, { broadcasterId: string; walletAddress?: string; lastSeen: number }> =
  {};
let chatMessages: Record<
  string,
  Array<{ message: string; senderAddress: string; senderName: string; timestamp: number }>
> = {};
let webrtcSignals: Record<
  string,
  Array<{ fromId: string; toId: string; signal: any; timestamp: number }>
> = {};
