  ...
  if (!item && !decoded) {
    return (
      <div className="px-4 py-6 md:px-6 lg:px-8">
        ...
        <div className="mt-4">
          <Link href="/dashboard/news" className="text-[#00b8d8] hover:underline">
            ← Back to News
          </Link>
        </div>
      </div>
  ...
  return (
    <div className="px-4 py-6 md:px-6 lg:px-8">
      ...
      <div className="mb-2 flex items-center gap-3">
        {src ? (
          <span className="text-xs uppercase tracking-wide text-[#00b8d8] font-semibold">
            {src}
          </span>
        ) : null}
      ...
      {item?.image ? (
        ...
        <img
          src={item.image}
          alt=""
          className="w-full max-h-[380px] object-cover rounded-lg border border-gray-800 mb-4"
        />
      ) : null}
      ...
      {link ? (
        <div className="mt-6">
          <a
            ...
            className="inline-block px-4 py-2 rounded-md border border-gray-700 text-white hover:bg-[#1a2932]"
          >
