...
const AdminLoginClient = dynamic(() => Promise.resolve(AdminLoginComponent), {
  ssr: true,
});
...
//               <Image src="/logo.png" alt="NYAX Logo" width={28} height={28} className="rounded" />
//             </div>
//             <div>
...
//                 Tip: defined by ADMIN_PASSWORD env
//               </div>
//             </div>
...
//                 <span className="text-green-400">●</span> Connected: {address.slice(0, 6)}...
//                 {address.slice(-4)}
//               </div>
//             )}
//             <button
...
//               Only pre-approved admin wallet addresses can access. Configure via{' '}
//               <code>ADMIN_WALLET_ADDRESSES</code>.
//             </div>
//           </div>
